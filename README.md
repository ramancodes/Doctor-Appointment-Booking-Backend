* Developed the doctor appointment booking platform using the MERN stack, enabling patients to book appointments, request second opinions, and manage their medical information. 
